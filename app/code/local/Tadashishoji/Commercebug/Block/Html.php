<?php
	class Tadashishoji_Commercebug_Block_Html extends Mage_Core_Block_Template
	{	
		...
		{
			$paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Tadashishoji_Commercebug'));
			$valid			= false;
	    ...
	    {	    	
	    	$module_dir = Mage::getModuleDir('', 'Tadashishoji_Commercebug');
        ...
        *   Tadashishoji_Commercebug_Block_Html
        ...
        */
        ...
        protected function _tabsAscommercebugLayout()
        {
            ...
            <?php
                $data = new stdClass();
                $data->dot = Tadashishoji_Commercebug_Model_Observer_Dot::renderGraph();
            ?>
