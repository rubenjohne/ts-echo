<?php 
	class Tadashishoji_Commercebug_Model_Collectorblocksandlayout extends Tadashishoji_Commercebug_Model_Observingcollector
	{
		...
		{		
			...
			foreach($this->_blocks as $block)
			{
				...
				if(strpos($class,'Tadashishoji_Commercebug') === 0)
				{
					continue;
				}
