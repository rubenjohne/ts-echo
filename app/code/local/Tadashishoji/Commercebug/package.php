<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Tadashishoji_Commercebug><active>true</active><codePool>local</codePool></Tadashishoji_Commercebug></modules></config>';
			$string = str_replace('Tadashishoji_', $this->namespace . '_',$string);
