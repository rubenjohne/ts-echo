...
class Mage_Directory_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        // array of regions that i want excluded in the states list
        $exclude_regions = array('AF', 'AA', 'AC', 'AE', 'AM','AP');
        ...
        if (!$this->_regionJson) {
            ...
            if (empty($json)) {
                ...
                foreach ($collection as $region) {
                    ...
                    // start block to filter regions here
                    $rg = $region->getCode();
                    ...
                    // end block to filter regions here
